...
[![Build Status](https://builds.gbif.org/job/hp-sib-peru/badge/icon)](https://builds.gbif.org/job/hp-sib-peru/lastBuild/console)
...
# GBIF Hosted Portal: Ictio-local

This Jekyll website, **[sib-peru (Staging)](https://sib-peru.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
...
Run docker command in `root` folder (where Gemfile exists!)
...
docker run -p "4000:4000" \
  ...
  docker.gbif.org/fast-jekyll:4.1.0 \
  jekyll serve --port 4000 --host 0.0.0.0 --config _config.yml,_config_test.yml
```
